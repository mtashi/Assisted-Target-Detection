...
if __name__ == '__main__':
    def main():
        ...
        filenames=[]
        for filename in glob.glob('/home/maryam/easy-faster-rcnn.pytorch/images/validation_images/*.jpg'):

                filenames.append(filename)

        #path_to_input_image = '/home/maryam/easy-faster-rcnn.pytorch/images/2014-10-01_04-34-54_IR_2014-10-01_i=13shift=13j-shift=1269_E.jpg'
        #_infer(path_to_input_image, '/home/maryam/easy-faster-rcnn.pytorch/images_my_img.jpg', path_to_checkpoint, dataset_name, backbone_name, prob_thresh)
        for i in range(len(filenames)):
        
                path_to_input_image = filenames[i] 

                _infer(path_to_input_image, '/home/maryam/easy-faster-rcnn.pytorch/images/validation_images/'+str(i)+'.jpg', path_to_checkpoint, dataset_name, backbone_name, prob_thresh)
