    ...
    while not should_stop:
        for _, (_, image_batch, _, bboxes_batch, labels_batch) in enumerate(dataloader):
            ...
            if step % 20== 0:
               ...
               eval._eval(path_to_checkpoint, 'NRCAirplanes', 'resnet50', './data', path_to_results_dir,step)
               
               with open('/home/maryam/easy-faster-rcnn.pytorch/outputs/m_output/avg_loss/train_avg_loss.txt', "a") as text_file:
