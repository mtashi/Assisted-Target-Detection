...
class Base(torch.utils.data.dataset.Dataset):
    ...
    OPTIONS = ['voc2007', 'coco2017', 'voc2007-cat-dog', 'coco2017-person', 'coco2017-car', 'coco2017-animal', 'NRCAirplanes']
    ...
    def from_name(name: str) -> Type['Base']:
        ...
        elif name == 'NRCAirplanes':
            from dataset.NRCAirplanes import NRCAirplanes
            return NRCAirplanes
        else:
            raise ValueError
